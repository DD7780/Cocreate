...
The 2026-09-23 presentation rollback restores the clean dark editorial UI and removes all liquid-metal, mercury, shader, and glass treatments. AI effort remains beside the canvas but is now one compact ChatGPT-style selector for Light, Medium, High, and Extra. This presentation change does not alter recommendation routing, permissions, budgets, submission, or collaboration behavior.
