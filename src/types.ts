...
export type RoomView={roomId:string;ownerId:string|null;ai:AIConnection;status:WorkflowStatus;participants:Participant[];latestVersion:number|null;versions:Version[];lastError?:string;debounceMs:number;buildDebounceMs:number;buildCooldownMs:number;usage:AIUsage;savedAt?:string;persistRevision:number;requirementsRevision:number};
