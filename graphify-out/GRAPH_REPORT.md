...
Cohesion: 0.15
Nodes (5): ref_node_assert_strict, ref_node_http, ref_node_test, ws, projectSchema
...
### Community 3 - "App.tsx"
Cohesion: 0.12
Nodes (18): @tiptap/extension-collaboration-caret, @tiptap/react, @tiptap/starter-kit, AgentPanel(), send(), AISetup(), api(), FormatChoice (+10 more)
...
Cohesion: 0.16
Nodes (17): AIConfig, boundedInput(), callOpenAI(), compactSharedRequirement(), generateProjectPlan(), mergeUsage(), ModelResult, productSchema (+9 more)
...
Cohesion: 0.09
Nodes (21): engines, node, name, private, type, version, cross-env, dotenv (+13 more)
...
Cohesion: 0.06
Nodes (23): ActorType, EventInput, EventStore, json(), redact(), RunState, StoredEvent, StoredRun (+15 more)
...
Cohesion: 0.32
Nodes (6): adapterFor(), discoverModels(), generateStructured(), mergeUsage(), ProviderConfig, schema
...
### Community 47 - "rooms.ts"
Cohesion: 0.05
Nodes (67): Named AI connections (preferred API), Shared response models, Migration, ref_node_crypto, ref_node_os, ref_node_sqlite, decryptSecret(), EncryptedSecret (+59 more)
...
Cohesion: 0.17
Nodes (15): esbuild, ref_node_fs_promises, ref_node_module, ref_node_path_posix, allowedExtensions, applyOperations(), generatedRoot, infrastructureFiles (+7 more)
...
Cohesion: 0.50
Nodes (4): Button(), buttonVariants, ref_base_ui_react_button, ref_class_variance_authority

### Community 63 - "CoCreate API reference"
Cohesion: 0.33
Nodes (6): Building and preview, CoCreate API reference, Legacy AI routes (currently retained), Maintenance, Transport and authentication, WebSocket collaboration
...
Cohesion: 0.47
Nodes (4): bundleSource(), validateSource(), keepLastSuccess(), shouldPromoteRevision()
...
- **Why does `react` connect `react` to `App.tsx`, `sidebar.tsx`, `package.json`, `combobox.tsx`, `menubar.tsx`, `context-menu.tsx`, `drawer.tsx`, `carousel.tsx`, `alert-dialog.tsx`, `chart.tsx`, `item.tsx`, `toast.tsx`, `attachment.tsx`, `field.tsx`, `alert.tsx`, `dialog.tsx`, `sheet.tsx`, `lucide-react`, `select.tsx`, `pagination.tsx`, `table.tsx`, `breadcrumb.tsx`, `command.tsx`, `card.tsx`, `avatar.tsx`, `bubble.tsx`, `message.tsx`, `ref_components_ui_button`, `input-otp.tsx`, `marker.tsx`, `toggle-group.tsx`, `main.tsx`?**
  _High betweenness centrality (0.325) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `lucide-react` to `pagination.tsx`, `App.tsx`, `sidebar.tsx`, `breadcrumb.tsx`, `command.tsx`, `package.json`, `combobox.tsx`, `ref_components_ui_button`, `context-menu.tsx`, `menubar.tsx`, `carousel.tsx`, `toast.tsx`, `input-otp.tsx`, `dialog.tsx`, `sheet.tsx`, `navigation-menu.tsx`, `select.tsx`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `CoCreate API reference` connect `CoCreate API reference` to `context.md`, `yjs`, `rooms.ts`?**
...
- **Should `RoomManager` be split into smaller, more focused modules?**
  _Cohesion score 0.08478341355053684 - nodes in this community are weakly interconnected._
